...
noise_threshold = 1e-5;  % Minimum peak height as a multiple of noise level
...
for i = 1:length(file_list)
    ...
    for channel = 2:2
        ...
        [processed_data, der_t, LL, LM, RM, RR, Map, Mip] = deriv_method(d, TH);
       ...
       % Filter peaks with prominence
        valid_pos_idx = p_pos > 1e-5;
        valid_neg_idx = p_neg > 1e-5;
